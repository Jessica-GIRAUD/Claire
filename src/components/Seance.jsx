...
const Seance = () => {
  return (
    <section className="creamPage" id="seance">
      <div class="custom-shape-divider-top-1638014272">
        <svg
          data-name="Layer 1"
          ...
          <div>
            ...
            <p className="numbers-container-txt">
              ...
              <p style={{ fontWeight: "bold", textAlign: "center" }}>
                Pour un accompagnement personnalisé et complet, je vous propose
                de réaliser d'un protocole adapté à votre objectif (entre 8 à 12
                séances).
              </p>
            </p>
          </div>
