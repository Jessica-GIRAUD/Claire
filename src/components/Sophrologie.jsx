      ...
      <div className="container-sophro">
        <div className="presentation-txt-pic-container">
          ...
          <p>
            ...
            reconnecter à lui en <strong>lâchant prise sur le mental</strong>.
            Cet entraînement corporel contribue à retrouver la sérénité au
            travers de techniques de relaxation (respiration et visualisation
            positive) qui sont <strong>adaptables et accessibles à tous</strong>
            .
          </p>
          <p>
