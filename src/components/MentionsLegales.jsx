    ...
    <div className="creamPage">
      <div className="container-mentions">
        ...
        <p>
          ...
          du site claire-deligne.fr l’identité des différents intervenants dans
        ...
        <p>
          L’utilisation du site claire-deligne.fr implique l’acceptation pleine
          ...
          complétées à tout moment, les utilisateurs du site claire-deligne.fr
        ...
        <p>
          ...
          décidée par Claire Deligné, qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
        </p>
        <p>
          Le site claire-deligne.fr est mis à jour régulièrement par Claire
          Deligné. De la même façon, les mentions légales peuvent être modifiées
        ...
        <p>
          Le site claire-deligne.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société. Claire Deligné
          s’efforce de fournir sur le site claire-deligne.fr des informations
        ...
        <p>
          Tous les informations indiquées sur le site claire-deligne.fr sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site claire-deligne.fr ne
        ...
        <p>
          ...
          site claire-deligne.fr, et résultant soit de l’utilisation d’un
          matériel ne répondant pas aux spécifications indiquées au point 4,
          soit de l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          Claire Deligné ne pourra également être tenue responsable des dommages
          indirects (tels par exemple qu’une perte de marché ou perte d’une
          chance) consécutifs à l’utilisation du site claire-deligne.fr. Des
          espaces interactifs (possibilité de poser des questions dans l’espace
          contact) sont à la disposition des utilisateurs.
        </p>
        <p>
          Claire Deligné se réserve le droit de supprimer, sans mise en demeure
        ...
        <p>
          Le cas échéant, Claire Deligné se réserve également la possibilité de
        ...
        <p>
          ...
          octobre 1995. A l’occasion de l’utilisation du site claire-deligne.fr,
          peuvent êtres recueillies : l’URL des liens par l’intermédiaire
          desquels l’utilisateur a accédé au site claire-deligne.fr, le
          fournisseur d’accès de l’utilisateur, l’adresse de protocole Internet
          (IP) de l’utilisateur. En tout état de cause Claire Deligné ne
        ...
        <p>
          ...
          précisé à l’utilisateur du site claire-deligne.fr l’obligation ou non
        ...
        <p>
          ...
          claire-deligne.fr n’est publiée à l’insu de l’utilisateur, échangée,
        ...
        <p>
          ...
          claire-deligne.fr n’est publiée à l’insu de l’utilisateur, échangée,
          transférée, cédée ou vendue sur un support quelconque à des tiers.
          Seule l’hypothèse du rachat de Claire Deligné et de ses droits
        ...
        <p>
          Le site claire-deligne.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Claire Deligné. Cependant, Claire Deligné n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n’assumera en
          conséquence aucune responsabilité de ce fait.
        </p>
        <p style={{ textAlign: "start" }}>
          La navigation sur le site claire-deligne.fr est susceptible de
        ...
        <p>
          Tout litige en relation avec l’utilisation du site claire-deligne.fr
