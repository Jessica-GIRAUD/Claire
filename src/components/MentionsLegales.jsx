    ...
    <div className="creamPage">
      <div className="container-mentions">
        ...
        <p>
          ...
          du site www.claire-deligne.fr l’identité des différents intervenants
        ...
        <div style={{ width: "100%" }}>
          <p>
            ...
            contact@www.claire-deligne.fr <br /> <br />
        ...
        <p>
          ...
          www.claire-deligne.fr sont donc invités à les consulter de manière
          régulière.
        </p>
        <p>
        ...
        <p>
          Le site www.claire-deligne.fr est mis à jour régulièrement par Claire
        ...
        <p>
          ...
          s’efforce de fournir sur le site www.claire-deligne.fr des
        ...
        <p>
          Tous les informations indiquées sur le site www.claire-deligne.fr sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site
          www.claire-deligne.fr ne sont pas exhaustifs. Ils sont donnés sous
        ...
        <p>
          ...
          site www.claire-deligne.fr, et résultant soit de l’utilisation d’un
        ...
        <p>
          ...
          chance) consécutifs à l’utilisation du site www.claire-deligne.fr. Des
        ...
        <p>
          ...
          www.claire-deligne.fr, peuvent êtres recueillies : l’URL des liens par
          l’intermédiaire desquels l’utilisateur a accédé au site
          www.claire-deligne.fr, le fournisseur d’accès de l’utilisateur,
          l’adresse de protocole Internet (IP) de l’utilisateur. En tout état de
          cause Claire Deligné ne collecte des informations personnelles
          relatives à l’utilisateur que pour le besoin de certains services
          proposés par le site www.claire-deligne.fr.
        </p>
        <p>
          ...
          précisé à l’utilisateur du site www.claire-deligne.fr l’obligation ou
        ...
        <p>
          ...
          www.claire-deligne.fr n’est publiée à l’insu de l’utilisateur,
        ...
        <p>
          ...
          www.claire-deligne.fr n’est publiée à l’insu de l’utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l’hypothèse du rachat de Claire Deligné et de ses droits
        ...
        <p style={{ textAlign: "start" }}>
          La navigation sur le site www.claire-deligne.fr est susceptible de
